...
int AalibLoad(char* filename, int channel, int loadToRam);
...
//
//		channel:One of PSPAALIB_CHANNEL_*
//		autoloop:intean value:
//				1:Enable autoloop and play until stopped.
//				0:Stop when end of stream is reached.
//
//		Returns 0 on success,>0 on error.
////////////////////////////////////////////////
...
////////////////////////////////////////////////
//		Retrieve tag of a MP3 File (only for SceMp3 Actualy).
//
//		channel:One of PSPAALIB_CHANNEL_*
//
//		returns the taf of file streamed, or > 0 on
//		error.
////////////////////////////////////////////////

//struct ID3Tag AalibGetTag(int channel);
