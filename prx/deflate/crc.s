...
sceGzipCrc32:
		lui			t0, %hi(_crc32_tbl)	// t0 = _crc32_tbl
		nor			a0, zero, a0		// a0 = ~a0
		addu		a2, a2, a1			// a2 = a2 + a1
0:
		beq			a2, a1, 1f
		addiu		a1, a1, 1			// a1 = a1 + 1
		lbu			t2, -1(a1)			// t2 = -1(a1)
		srl			v0, a0, 8			// v0 = a0>>8
		xor			t2, t2, a0			// t2 = t2 & a0 (1clock stall)
		andi		t2, t2, 0x00FF		// t2 = t2 & 0x000000FF
		sll			t2, t2, 2			// t2 = t2<<2
		addu		t2, t2, t0			// t2 = t2 + t0 = t2 + _crc32_tbl
		lw			t2, %lo(_crc32_tbl)(t2)		// t2 = _crc32_tbl[a0 ^ (a1)]
		j			0b
		xor			a0, v0, t2			// a0 = v0 ^ t2 (delay slot)
1:
		jr			ra					//J ƒŠƒ^[ƒ“
		nor			v0, zero, a0		// v0 = ~a0 (delay slot)
